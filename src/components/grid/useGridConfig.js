...
export function useGridConfig() {
  ...
  useEffect(() => {
    ...
    if (bgControls) {
      CONFIG.bgColor = bgControls.bgColor ?? "#080810";
      CONFIG.bgOpacity = bgControls.bgOpacity ?? 0.9;
      CONFIG.bgSpeed = bgControls.bgSpeed ?? 0.03;
      CONFIG.bgScale = bgControls.bgScale ?? 2.5;
      CONFIG.bgLineThickness =
        bgControls.bgLineThickness ?? 0.025;
    }
  }, [controls, animationControls, bgControls]);
